...
urlpatterns = [
    ...
    # new for student and faculty login
    ...
    # new for students claim project
    path('student-assignments-claim/<int:code>/',
         views.allAssignmentsSTD_claim, name='student-assignments-claim'),
    #
